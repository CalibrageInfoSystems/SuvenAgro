...
public class DatabaseKeys {
    ...
    public final static String EmpPunchDetails = "EmpPunchDetails";
    public final static String DripIrrigation = "DripIrrigation";
    public final static String AdvancedDetails = "AdvancedDetails";
    public final static String SaplingDispatchRequest = "SaplingDispatchRequest";
    public final static String NurserySaplingDetails = "NurserySaplingDetails";
