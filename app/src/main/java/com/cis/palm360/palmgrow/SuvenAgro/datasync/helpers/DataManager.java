...
public class DataManager<T> {
    ...
    public static final String MISSING_PLANTATION_IMAGES = "MISSING_PLANTATION_IMAGES";
    public static final String MISSING_PLANTATION_IMAGES_BY_FINISH = "MISSING_PLANTATION_IMAGES_BY_FINISH";
    public static final String PLOT_DETAILS_IMAGES = "PLOT_DETAILS_IMAGES";
    public static final String RYTHU_DIARY = "rythuDiary";
    ...
    public static final String ADVANCE_DETAILS_UPDATE= "ADVANCE_DETAILS_UPDATE";
    ...
    public static final String PPB1 = "PPB1";
    public static final String PPB2 = "PPB2";
