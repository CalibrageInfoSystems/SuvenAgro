...
public class CommonConstants {
    ...
    public static int plotDetailsModuleTypeId = 844;
    public static int rythuDiaryModuleTypeId = 845;
    public static int missingTreeModuleTypeId = 846;
   ...
   // public static String IS_MASTER_SYNC_SUCCESS = "null";
    ...
    public static String advancedModel = "advancedModel";
    public static String dispatchModel = "dispatchModel";
    public static String reciptNumbers = "reciptNumbers";
    ...
    public static String punchSharedPreferences ="punchSharedPreferences";
    public static String punchStatus ="punchStatus";
    ...
    public static String REGISTRATION_SCREEN_FROM_DripFOLLOWUP = "registration_screen_from_Drip_followup";
    ...
    public static String REGISTRATION_SCREEN_FROM_MANAGE_ADVANCE_DETAILS = "REGISTRATION_SCREEN_FROM_MANAGE_ADVANCE_DETAILS";
    public static String REGISTRATION_SCREEN_FROM_MANAGE_View_DispatchSaplings = "REGISTRATION_SCREEN_FROM_View_DispatchSaplings_DETAILS";

    public static String REGISTRATION_SCREEN_FROM_addDispatchSaplings = "REGISTRATION_SCREEN_FROM_addDispatchSaplings";
    public static String VIEW_DISPATCH_SAPLING_DETAILS = "VIEW_DISPATCH_SAPLING_DETAILS";
    public static String REGISTRATION_SCREEN_FROM_raiseDispatchSaplingsRequest = "REGISTRATION_SCREEN_FROM_raiseDispatchSaplingsRequest";
    ...
    public static String STATUS_TYPE_ID_DripPending = "DripIrrigationPending";
...
//    public static int CanalOthersID = 131;
    ...
    public static Integer isFieldMarkingDone = 0;
    public static String fieldMarkingDate = "";

    public static Integer isPittingDone = 0;
    public static String pittingDate = "";

    public static Integer isDripSurveyDone = 0;
    public static String dripSurveyDate ="";

    public static Integer isAdministrationPermissionGranted = 0;
    public static String administrationPermissionDate = "";

    public static Integer isDripSharePaid = 0;
    public static String dripSharePaidDate ="";

    public static Integer isDripInstalled = 0;
    public static String dripInstallationDate = "";
    public static boolean isDripCompleted = false;
