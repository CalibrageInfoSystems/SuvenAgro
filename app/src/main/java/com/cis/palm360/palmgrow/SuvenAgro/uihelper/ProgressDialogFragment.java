package com.cis.palm360.palmgrow.SuvenAgro.uihelper;
...
public class ProgressDialogFragment extends DialogFragment {
    ...
    public void updateText(final String statusMessage) {
        ApplicationThread.uiPost(LOG_TAG, "data download status", new Runnable() {
            @Override
            public void run() {
                if (downLoadStatusTxt != null && isAdded() && getView() != null) {
